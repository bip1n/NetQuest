...
export const SignIn = (props: IconSvgProps)=>(
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
  <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 8.25 21 12m0 0-3.75 3.75M21 12H3" />
</svg>
);

export const VenueIcon = (props: IconSvgProps)=>(
...
export const PhoneIcon = (props: IconSvgProps)=>(
  ...
  export const MapPin = (props: IconSvgProps)=>(
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.3" stroke="currentColor" className="size-5">
...
export const DoubleupIcon = (props: IconSvgProps)=>(
...
export const ClickedDoubleupIcon = (props: IconSvgProps)=>(
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="3" stroke="blue" className="size-6">
  <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 18.75 7.5-7.5 7.5 7.5" />
  <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 7.5-7.5 7.5 7.5" />
</svg>
)
...
export const NotificationIcon: React.FC<IconSvgProps> = (props) => (
  <svg 
    ...
    {...props}
    className="w-6 h-6" // Adjust size with Tailwind classes
  >
    <path 
      ...
      strokeLinecap="round" 
      strokeLinejoin="round" 
      className="text-black dark:text-white" // Example Tailwind classes for stroke color
    />
  </svg>
);


export const WifiIcon = (props: IconSvgProps)=>(
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5">
...
export const FoodIcon = (props: IconSvgProps)=>(
...
export const RupeeIcon = (props: IconSvgProps)=>(
...
export const ClockCircleLinearIcon: React.FC<IconSvgProps> = (props) =>(
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
